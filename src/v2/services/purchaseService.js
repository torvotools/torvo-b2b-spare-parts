...
export const purchaseService={
 ...
 async catalog(){return ok(await supabase.from('catalog_items').select('id,item_code,oem_code,name,brand,category,item_type,active').eq('active',true).order('item_code').limit(1000))},
