...
import './styles.css';import'./workspace-polish.css';import'./login-preview.css';import'./dealer-mobile-fix.css';import'./premium-ui.css';import'./compact-cloud-ui.css';import'./public-website.css';
...
const Preview=visual==='admin'?AdminVisualPreview:visual==='login'?LoginVisualPreview:visual==='register'?DealerRegistrationPreview:visual==='app'||visual==='dealer'?DealerVisualPreview:PublicWebsitePreview;
const links=[['website','WEBSITE'],['app','DEALER APP'],['login','LOGIN'],['register','DEALER REGISTER'],['admin','ADMIN DEMO']];
