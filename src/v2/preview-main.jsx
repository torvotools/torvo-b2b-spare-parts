...
const showPreviewTools=params.get('previewTools')==='1';function PreviewRoot(){useEffect(()=>installGlobalUiFeedback(),[]);return <><Preview/>{showPreviewTools&&<Switcher/>}</>};createRoot(root).render(<React.StrictMode><PreviewRoot/></React.StrictMode>);
