...
- Dealer delivery/tracking reads require current device proof and return only that Dealer's dispatch records; tracking codes are never accepted from the browser as authorization.
