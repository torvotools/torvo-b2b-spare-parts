...
const checks=[
 ...
 ['DEALER USER BOUND BEFORE ACCEPT',/auth_user_id=auth\.uid\(\) and active=true and dealer_id=did/i.test(sql)],
 ['ACTIVE APP USER BEFORE AUDIT',/if au is null then raise exception 'ACTIVE DEALER APP USER REQUIRED'/i.test(sql)],
