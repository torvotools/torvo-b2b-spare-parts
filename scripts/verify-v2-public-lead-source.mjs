...
const service=read('src/v2/services/publicWebsite.js'),source=read('src/v2/services/publicLeadSource.js'),sql=read('supabase/v2-public-lead-source.sql'),order=read('supabase/V2_INSTALL_ORDER.md');
...
console.log('TORVO V2 public lead source contract OK');
