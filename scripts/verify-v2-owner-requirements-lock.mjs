...
const immutableRules=['torvo-v2-build','V27/main','RATE A / RATE B / RATE C','Rs 10,000','7027751533','com.torvotools.app','CAMERA before MIC','No public TORVO selling price','Admin/Accountant secure desktop','ADD MORE ITEMS','one active mobile device','dropdowns/selectors to the fullest practical extent','searchable dropdowns','STATE -> DISTRICT -> CITY','Dependent dropdowns must reset invalid child selections','Reuse authoritative master data'];
