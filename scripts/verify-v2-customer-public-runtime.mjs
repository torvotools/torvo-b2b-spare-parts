...
const checks=[
 ...
 ['TORVO HELP MOBILE OWNERSHIP HINT',/join customer_contacts c on c\.id=x\.customer_id[\s\S]*where x\.id=p_demand_id and right\(regexp_replace\(coalesce\(c\.mobile,''\),'\\D','','g'\),10\)=m/i.test(demand)],
