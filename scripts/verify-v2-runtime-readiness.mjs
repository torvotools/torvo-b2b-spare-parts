...
const checks=[
 ...
 ['STAFF LOGIN EDGE FUNCTION PRESENT',staff.includes('staff_verify_one_time_password')&&staff.includes('staff_create_verified_session')&&staff.includes('establishSession')],
