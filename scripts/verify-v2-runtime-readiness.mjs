...
const checks=[
 ...
 ['DUAL LOGIN CONTRACT DOCUMENTED',install.includes('SALESMAN / STORE KEEPER / ACCOUNTANT NORMAL LOGIN = ADMIN USERNAME + ONE-TIME PASSWORD')&&install.includes('ONE DEALER ACCOUNT MAY HAVE ONLY ONE ACTIVE APP DEVICE SESSION')],
