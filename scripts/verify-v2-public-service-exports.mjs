...
for(const arg of['p_state:text(state,120)||null','p_district:text(district,120)||null','p_city:text(city,120)||null'])if(!enquiryBody.includes(arg))fail(`PRODUCT ENQUIRY LOCATION ARGUMENT MISSING: ${arg}`);
