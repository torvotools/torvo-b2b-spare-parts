...
const checks=[
 ...
 ['DEMAND PAYLOAD BOUNDED',/cleanText\(name,120\)/.test(svc)&&/cleanText\(searchText,200\)/.test(svc)&&/cleanText\(brand,120\)/.test(svc)&&/cleanText\(modelNumber,120\)/.test(svc)&&/cleanText\(requirementNote,500\)/.test(svc)],
 ...
 ['RESULT ID NORMALIZED',/loadCustomerProductDemandResult[\s\S]*cleanId\(demandId\)/.test(svc)&&/p_demand_id:id/.test(svc)],
 ['HELP ID NORMALIZED',/requestTorvoProductHelp[\s\S]*cleanId\(demandId\)/.test(svc)&&/p_demand_id:id/.test(svc)],
 ...
 ['RESULT FIXED FIELD SHAPE',/return\{demand_id:result\.demand_id\|\|id,status,search_text:cleanText\(result\.search_text,200\),message:cleanText\(result\.message,500\)/.test(svc)],
 ...
 ['RESULT TEXT BOUNDED',/found_contact_note:status==='available'\?cleanText\(result\.found_contact_note,1000\)/.test(svc)],
