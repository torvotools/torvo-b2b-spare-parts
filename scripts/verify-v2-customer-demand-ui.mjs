...
const checks=[
 ...
 ['RESULT FIXED FIELD SHAPE',/return\{demand_id:result\.demand_id\|\|id,status,search_text:String\(result\.search_text\|\|''\)\.trim\(\),message:String\(result\.message\|\|''\)\.trim\(\)/.test(svc)],
