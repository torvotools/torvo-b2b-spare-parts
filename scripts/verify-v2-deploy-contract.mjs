...
const gates=[
 ...
 ['DOMAIN DNS EXTERNAL DEPENDENCY',releaseGates.includes('DOMAIN/DNS')&&releaseGates.includes('FINAL DEPLOYMENT DEPENDENCIES')],['CLOUDFLARE DOES NOT IGNORE DOC CONTRACTS',!workflow.includes("paths-ignore:\n      - 'docs/**'")],['BUILD WATCHES RESTORE CONTRACT',buildWorkflow.includes("docs/TORVO-V2-PORTABLE-RESTORE-RUNBOOK.md")&&buildWorkflow.includes("docs/TORVO-V2-RESTORE-GUIDE.md")&&buildWorkflow.includes("docs/TORVO-V2-MASTER-HANDOVER.md")],['ANDROID GATED BY SUCCESSFUL BUILD',androidWorkflow.includes('workflow_run:')&&androidWorkflow.includes('TORVO V2 Build Check')&&androidWorkflow.includes("github.event.workflow_run.conclusion == 'success'")],['BUILD WATCHES ENV INVENTORY',buildWorkflow.includes("docs/TORVO-V2-ENVIRONMENT-INVENTORY.md")],['ANDROID USES EXACT SUCCESSFUL BUILD SHA',androidWorkflow.includes('github.event.workflow_run.head_sha')&&androidWorkflow.includes('SOURCE_SHA')],['BUILD WATCHES FINAL ACCEPTANCE CONTRACTS',buildWorkflow.includes("docs/TORVO-V2-PUBLIC-WEB-APP-ARCHITECTURE.md")&&buildWorkflow.includes("docs/TORVO-V2-FINAL-DEMO-RUNBOOK.md")&&buildWorkflow.includes("docs/TORVO-V2-OWNER-REQUIREMENTS-LOCK.md")],['ANDROID INHERITS BUILD ACCEPTANCE CONTRACTS',buildWorkflow.includes("docs/TORVO-V2-PUBLIC-WEB-APP-ARCHITECTURE.md")&&buildWorkflow.includes("docs/TORVO-V2-FINAL-DEMO-RUNBOOK.md")&&buildWorkflow.includes("docs/TORVO-V2-OWNER-REQUIREMENTS-LOCK.md")&&androidWorkflow.includes('TORVO V2 Build Check')],
